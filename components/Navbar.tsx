...
export const  Navbar = ({isDarkMode , setIsDarkMode }: NavbarProps) => {
    ...
    return (
        ...
        <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : "" }`}>
            ...
            <ul className={`hideen md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 ${isScroll ? " " : "bg-white shadow-sm bg-opacity dark:border:border-white/50 dark:bg-transparent"} `}>
